...
那么我们则可以知道发送速率 B 为
$$
B=\frac{E[M]}{E[S]}=\frac{E[n]E[Y]+E[R]}{E[n]E[A]+E[Z^{TO}]} = \frac{E[Y]+Q*E[R]}{E[A]+Q*E[Z^{TO}]}
$$
其中未知的还有 E[Z^TO] 和 Q。
...
$$
P[R=k]=p^{k-1}(1-p)\quad\mathrm{~for~}k=1,2,...
$$
由于 timeout 会按指数增加
$$
L_k=(2^k-1)T_O\quad
...
最后，其实我们觉着，有些假设还是比较强的，没有考虑 buffer 的作用，RTT 与 Wi 独立不相关。
